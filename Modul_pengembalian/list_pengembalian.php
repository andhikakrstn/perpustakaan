<?php
include 'proses_list_pengembalian.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="content">
            ...
            <table class="data">
                ...
                <tr>
                    ...
                    <td>
                    <a href="delete_pengembalian.php?id_kembali=<?php echo $kembali['kembali_id'] ?>" onclick="return confirm('anda yakin akan menghapus data?')" class="btn btn-hapus">Hapus</a>
                    </td>
                </tr>
                <?php endforeach ?>
